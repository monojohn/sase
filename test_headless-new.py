...
def test_simple_demo_form():
    ...
    download_dir = "/Users/monoj/Downloads/industry.csv"
    ...
    driver.get("https://cdn.wsform.com/wp-content/uploads/2020/06/industry.csv")

    #element = driver.find_element(By.ID, "1 MB PDF Download")
    #element.click()
